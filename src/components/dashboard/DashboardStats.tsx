    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
      {statsConfig.map((stat, index) => {
        ...
        return (
          <div 
            key={index} 
            className="bg-white rounded-xl p-3 border border-gray-200 hover:shadow-lg hover:border-[#0158B7]/20 transition-all duration-200 hover:-translate-y-0.5"
          >
            <div className="flex items-center justify-between mb-1.5">
              <div className={`p-1 rounded-lg ${colors.iconBg} shadow-sm`}>
