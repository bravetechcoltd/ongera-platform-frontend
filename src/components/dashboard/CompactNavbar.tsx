...
const getSidebarItems = (
  ...
  return [
    ...
    // Institution Portal (only for Institution admin accounts)
    {
    ...
    // Institution Portal (for portal members — students/researchers added by an institution)
    {
    ...
    // Filter by institution membership (portal members: students / researchers)
    if (item.requiresInstitutionMember === true && !isInstitutionMember) {
      return false
    }
