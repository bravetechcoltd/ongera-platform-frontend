...
export default function CompactNavbar() {
  ...
  return (
    <>
      {/* Top Navigation Bar - UPDATED: Increased z-index to 60 */}
                  ...
                  <div key={item.title} className="relative">
                    {hasSubItems ? (
                      <div className="relative">
                        ...
                        {/* Dropdown Menu - UPDATED: Increased z-index to 70 */}
                        {isExpanded && (
      ...
      {/* Mobile Slide-out Menu - UPDATED: Increased z-indexes */}
      {mobileOpen && (
        <>
          {/* Overlay - UPDATED: Increased z-index to 60 */}
          <div 
            className="fixed inset-0 bg-black bg-opacity-50 z-60 lg:hidden"
            onClick={() => setMobileOpen(false)}
          />
          
          {/* Slide Menu - UPDATED: Increased z-index to 70 */}
          <div className="fixed top-0 left-0 bottom-0 w-72 bg-white shadow-2xl z-70 lg:hidden overflow-y-auto">
            <div className="p-3 border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h1 className="font-bold text-gray-900 text-md">Ongera</h1>
