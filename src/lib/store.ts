...
import institutionWorkReducer from './features/auth/institutionWorktogetherSlices'
import institutionResearchReducer from './features/auth/institutionResearchSlice'
import industrialSupervisorReducer from './features/auth/industrialSupervisorSlice'
...
const rootReducer = combineReducers({
    ...
    institutionWorktogether: institutionWorkReducer,
    institutionResearch: institutionResearchReducer,
    industrialSupervisor: industrialSupervisorReducer,
