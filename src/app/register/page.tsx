...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (formData.account_type === 'Institution') {
      ...
      // ✅ Standard user validation (Student, Researcher, Diaspora)
  ...
  // ✅ Check if account type is Institution
            ...
            <div className="p-5 md:p-6 lg:p-7 max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                {isInstitution ? (
                  ...
                  // ===== STANDARD USER FIELDS (Student, Researcher, Diaspora) =====
                  <>
                ...
                {/* ✅ SHARED FIELDS - Email, Phone, Password (for ALL account types) */}
                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-1.5">
