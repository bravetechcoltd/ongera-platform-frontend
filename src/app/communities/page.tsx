...
import {
  ...
  Globe, Lock, Building, Eye, MessageSquare
} from "lucide-react"
                  ...
                  >
                    ...
                    <div className="h-48 bg-gradient-to-br from-[#0158B7] to-[#0362C3] flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="absolute top-3 right-3">
                        <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold ${getCommunityTypeColor(community.community_type)}`}>
                      ...
                      {community.creator && (
                        <div className="mt-3 pt-3 border-t border-gray-200 flex items-center gap-2">
                          ...
                          <span className="text-xs text-gray-600">
                            Created by {community.creator.first_name} {community.creator.last_name}
                          </span>
                        </div>
                      )}
                    </div>
