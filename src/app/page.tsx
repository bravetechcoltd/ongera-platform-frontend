...
// Enhanced Navigation with Curved Bottom - FIXED
function Navigation() {
        ...
        >
          ...
          >
            <motion.input
              ...
              className="flex-1 px-5 py-3 rounded-full text-white ring-white/50 shadow-xl focus:outline-none focus:ring-4 focus:ring-white/50 shadow-xl font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            />
            <motion.button
              type="submit"
              disabled={isSubmitting}
...
function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-[#0158B7] to-[#0362C3] text-white py-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="group relative w-12 h-12 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/30 transition-all shadow-lg"
            title="Back to Top"
          >
            <motion.div
              animate={{ y: [-2, 2, -2] }}
            ...
            <span className="absolute right-14 bg-white text-[#0158B7] px-3 py-1.5 rounded-lg text-xs font-semibold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg">
              Back to Top
            </span>
          </motion.button>
        </div>
