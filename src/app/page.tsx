      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center group mt-3">
            <motion.div
              className="w-[160px] h-16  rounded-xl flex items-center justify-center overflow-hidden  bg-white/5 backdrop-blur-sm mb-3"
...
// ResearchShowcase with image cards
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {filteredProjects.slice(0, 3).map((item, i) => (
              <motion.div
                ...
                className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all cursor-pointer border border-gray-100"
              >
                {/* Top Image Section - Full width, proper aspect ratio */}
                <div className="relative h-40 w-full overflow-hidden bg-gradient-to-br from-[#0158B7] to-[#0362C3]">
                ...
                <div className="p-4">
                  ...
                  {item.author?.profile?.institution_name && (
                    <div className="flex items-center text-xs text-gray-500 mb-2">
                      ...
                      <span className="truncate">{item.author.profile.institution_name}</span>
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                    ...
                    <button className="text-[#0158B7] font-semibold hover:text-[#0362C3] transition-colors text-xs flex items-center">
                      Read More
...
// CommunityHighlights with image cards
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {communities.slice(0, 3).map((community, i) => (
                ...
                >
                  {/* Top Image Section */}
                  <div className="relative h-40 w-full overflow-hidden bg-gradient-to-br from-[#0158B7] to-[#5E96D2]">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                      ...
                      <button className="bg-gradient-to-r from-[#0362C3] to-[#5E96D2] text-white px-3 py-1.5 rounded-lg text-xs font-medium hover:shadow-md transition-all">
                        View Community
                      </button>
                    </div>
                  </div>
...
// EventsPreview with image cards
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {displayEvents.map((event, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer hover:shadow-xl transition-all border border-gray-100"
                >
                  {/* Top Image Section */}
                  <div className="relative h-40 w-full overflow-hidden bg-gradient-to-br from-[#0158B7] to-[#0362C3]">
                    ...
                    {/* Featured Badge */}
                    {index === 0 && (
                      <div className="absolute top-2 left-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white text-xs px-2 py-1 rounded-lg font-bold shadow-lg">
                        FEATURED
                      </div>
                    )}
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          >
            <Link href="/" className="group inline-block">
              <motion.div
                className="w-[160px] h-16 rounded-xl flex items-center justify-center overflow-hidden  bg-white/10 backdrop-blur-md mb-3"
                whileHover={{ scale: 1.05, borderColor: 'rgba(255, 255, 255, 0.6)' }}
                transition={{ type: "spring", stiffness: 300 }}
              >
                <Image
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-center md:text-left">
              <p className="text-white/90 text-xs font-medium mb-0.5">
                © 2025 Bwenge • All rights reserved
              </p>
            ...
            <div className="text-center md:text-right">
              <p className="text-white/70 text-xs mb-1">
                By using Bwenge, you agree to our policies
              </p>
