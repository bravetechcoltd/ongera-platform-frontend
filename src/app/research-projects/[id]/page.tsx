      ...
      <div className="max-w-5xl mx-auto px-4 pt-24 pb-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-lg">
          ...
          <div className="relative h-80 w-full bg-gradient-to-br from-[#0158B7] to-[#0362C3]">
            ...
            {/* Date Badge */}
            <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-sm text-white px-3 py-1.5 rounded-lg text-sm">
              Published {formatDate(project.publication_date || project.created_at)}
            </div>
