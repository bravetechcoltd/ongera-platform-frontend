...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (response.data && response.data.success) {
      setStatus('success')
      setMessage(
        'You have been successfully unsubscribed from all Ongera notifications.'
      )
    } else {
      setStatus('error')
      setMessage(
                ...
                <>
                  <div className="text-center mb-6">
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Enter your email address to unsubscribe from all Ongera platform notifications, including research projects, communities, and events.
                    </p>
                  </div>
