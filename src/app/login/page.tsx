...
import {
  ...
  Search, MapPin, Globe, GraduationCap, Building, UserPlus, Clock, XCircle, Info
} from 'lucide-react'
            ...
            <div className="p-5 md:p-6 lg:p-7">
              ...
              {error && errorCode === 'NO_ACCOUNT' && (
                ...
                >
                  ...
                  <Link
                    href="/register"
                    className="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-600 text-white rounded-md text-xs font-semibold hover:bg-amber-700 transition-colors"
                  >
                ...
                >
                  <div className="flex items-start gap-2 mb-2">
                    ...
                    <div className="flex-1">
                      ...
                      {rejectionReason && (
                        <div className="mt-2 p-2 bg-white/60 border border-red-100 rounded">
                          <p className="text-xs font-medium text-red-900 mb-0.5">Reason:</p>
                  ...
                  <a
                    href="mailto:support@bwenge.com"
                    className="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 bg-red-600 text-white rounded-md text-xs font-semibold hover:bg-red-700 transition-colors"
                  >
