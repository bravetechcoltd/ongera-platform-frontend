      ...
      <main className="max-w-[800px] mx-auto px-6 py-24">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Thank you for joining Bwenge (Unique Rwandans research platform). At the Bwenge research platform, 
        ...
        <div className="mb-16 prose prose-lg max-w-none">
          <p className="text-gray-700 leading-relaxed mb-6">
            Welcome to Bwenge collaboration space policies, terms, and commitments. At Bwenge, we're passionate about 
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            to understand how Bwenge strives to make knowledge-sharing open, inclusive, and secure for everyone.
          </p>
        </div>
        ...
        <section id="privacy-policy" className="mb-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Bwenge is a digital platform designed to promote research, innovation, and skills-sharing among Rwandans 
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Bwenge is open to all Rwandan citizens at home and abroad, to all private and governmental institutions 
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="text-[#0158B7] mr-2">•</span>
                  <span>Agree to follow the Bwenge Terms of Use and Privacy Policy.</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                such as your preferred content, and make your experience on Bwenge easier and more personalized.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="terms-service" className="mb-16">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                All creators retain ownership of their work but grant Bwenge a non-exclusive license to display and share 
            ...
            <div>
              ...
              <div className="mt-4 p-4 bg-[#FEF9E7] border-l-4 border-[#F39C12] rounded">
                <p className="text-sm text-gray-700">
                  <strong>Note:</strong> Users can appeal disciplinary actions through Bwenge's support channel within 
        ...
        <section id="privacy-protection" className="mb-16">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Bwenge respects user privacy and will not share personal data without consent. Members must also protect 
        ...
        <section id="partners" className="mb-16">
          ...
          <p className="text-gray-700 leading-relaxed">
            If you are accessing Bwenge through an organization or institution partnership, please review the specific 
        ...
        <section id="policy-updates" className="mb-16">
          ...
          <p className="text-gray-700 leading-relaxed">
            Bwenge may update this policy from time to time. Users will be notified of significant changes. Continued 
        ...
        <section id="advertising" className="mb-16">
          ...
          <p className="text-gray-700 leading-relaxed">
            Bwenge is committed to truthful and accurate advertising. We constantly work to ensure its advertising 
