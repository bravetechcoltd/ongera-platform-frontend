...
import {
  ...
  PenTool, FileEdit, GraduationCap, ShieldCheck
} from 'lucide-react'
...
const adminSidebarItems = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { title: "User Applications", href: "/dashboard/admin/users/applications" }
    ]
  },
  {
  ...
  },
  {
    ...
    icon: Globe,
    subItems: [
      { title: "Manage Partners", href: "/dashboard/admin/institution-work" }
    ]
  },
  {
    ...
    icon: GraduationCap,
    subItems: [
      { title: "Institution Projects", href: "/dashboard/admin/institution-projects" },
      { title: "Industrial Supervisors", href: "/dashboard/admin/industrial-supervisors" }
    ]
  },
]
