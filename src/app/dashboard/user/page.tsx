...
import { Loader2, Search, Users, Building2, ArrowRight, ChevronRight, Sparkles, BookOpen, GraduationCap, Clock, Globe, Zap, TrendingUp, Award, Upload, MessageSquare, Heart } from "lucide-react"
  ...
  return (
    <div className="space-y-3 max-w-[1400px] mx-auto pb-3 px-8">
        ...
        <div className="relative flex items-center justify-between gap-4 z-10 min-h-[80px]">
          ...
          >
            ...
            <div className="flex items-center gap-2 pl-2 border-l border-white/20">
              ...
              <div className="flex items-center gap-3">
      {/* SMART ACTIVITIES BUTTON - Small, visible, on right */}
      <motion.button
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        onClick={() => router.push('/dashboard/user/activity')}
        className="flex items-center gap-1.5 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/30 transition-all duration-200 group relative overflow-hidden"
      ...
      >
        ...
        <span className="text-sm font-semibold whitespace-nowrap">Activities</span>
