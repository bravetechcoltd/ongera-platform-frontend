            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
              {blogs.map(blog => (
                ...
                >
                  ...
                  {/* Content */}
                  <div className="p-3">
                    <h3 className="font-bold text-sm text-gray-900 mb-1.5 line-clamp-2 group-hover:text-[#0158B7] transition-colors">
                      {blog.title}
                    </h3>
                    ...
                    <div className="flex items-center gap-2">
                      {blog.author?.profile_picture_url ? (
                        ...
                        <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#0158B7] to-[#5E96D2] flex items-center justify-center text-white text-[10px] font-bold">
              ...
              {blogs.map(blog => (
                ...
                >
                  <div className="flex flex-col sm:flex-row">
                    {/* Cover Image */}
                    <div className="relative w-full sm:w-40 h-32 sm:h-auto bg-gradient-to-br from-[#0158B7] to-[#5E96D2] flex-shrink-0 overflow-hidden">
                      {blog.cover_image_url ? (
                        <img 
                          src={blog.cover_image_url} 
                          alt={blog.title} 
