          ...
          {events.map((event) => {
            ...
            return (
              <div key={event.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-all group">
                {/* Cover Image - Enhanced with Full Display */}
                <div className="relative h-48 bg-gradient-to-br from-[#0158B7] to-[#5E96D2] overflow-hidden">
                ...
                {/* Content */}
                <div className="p-3">
                  <h3 className="font-bold text-gray-900 text-sm mb-1.5 line-clamp-2 hover:text-[#0158B7] cursor-pointer transition-colors">
                    {event.title}
                  </h3>
