...
import { createProject } from "@/lib/features/auth/projectSlice"
import RichTextEditor from "@/components/ui/richTextEditor"
import {
  FileText, Upload, Image as ImageIcon, X, Plus, Loader2,
  Save, Eye, Send, Tag, Calendar, Globe, Users, Check,
  AlertCircle, Paperclip, BookOpen, Sparkles, ArrowLeft
} from "lucide-react"
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">Share your research with the community</p>
            </div>
          </div>
        </div>
                ...
                {currentStep === 4 ? (
                  <>
                    <button
                      ...
                      className="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:border-gray-400 transition-all text-xs font-medium flex items-center gap-1"
                    >
