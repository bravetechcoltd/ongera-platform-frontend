...
export default function JoinRequestsPage() {
  ...
  const handleConfirmAction = async (requestId: string, reason?: string) => {
    try {
      ...
      // Close modal and reset state AFTER successful action
    ...
    <>
      <div className="p-6 max-w-6xl mx-auto space-y-6">
        <Link
          ...
          className="inline-flex items-center text-gray-600 hover:text-[#0158B7] transition-colors group"
        >
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex flex-col space-y-2 ml-4">
                      <button
                        ...
                        className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-xl hover:shadow-lg hover:from-emerald-700 hover:to-teal-700 transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                      ...
                      <button
                        ...
                        disabled={isSubmitting}
                        className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:shadow-lg hover:from-red-600 hover:to-red-700 transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                      >
