...
export default function ManageResourcesPage() {
  ...
  const tabs: Tab[] = [
    { id: "projects", label: "Projects", icon: FolderOpen, count: adminProjects.length },
    { id: "events", label: "Events", icon: Calendar, count: adminEvents.length },
    { id: "blogs", label: "Blogs", icon: FileText, count: blogs.length },
    { id: "qa", label: "Q&A", icon: MessageSquare, count: threads.length },
  ]
